...
class SolicitudAveriaElectrodomesticosScreen extends StatefulWidget {
  const SolicitudAveriaElectrodomesticosScreen({super.key});

  @override
  State<SolicitudAveriaElectrodomesticosScreen> createState() =>
      _SolicitudAveriaElectrodomesticosScreenState();
}

class _SolicitudAveriaElectrodomesticosScreenState
    extends State<SolicitudAveriaElectrodomesticosScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Comunicación de avería \nde electrodomésticos."),
      ),
  ...
  Widget cuerpo(BuildContext context, ThemeData theme) {
    return Padding(
      ...
      child: Column(
        children: [
          CustomComment(text: "Comunicación de avería de electrodomésticos."),
          ...
          CustomCard(
            child: Column(
              ...
              children: [
                const CustomText(
                  "Formulario de Comunicación de avería de electrodomésticos.",
                ...
                TextButton(
                  onPressed: () => lanzarUrl('URL_SOLICITUD_COMUNICACION_AVERIA'),
                  child: const Text(
                    "Descargar Formulario de Comunicación de avería de electrodomésticos.",
                  ),
                ),
          ...
          buildMediaCard(
            title: "a) Formulario de comunicación de avería de electrodomésticos.",
          ...
          buildMediaCard(
            title: "b) Presupuesto de la reparación de los daños IVA incluido.",
            files: selectedFileCopiaSimpleCarnetElectricistaList,
            onChanged: (lista) =>
                setState(() => selectedFileCopiaSimpleCarnetElectricistaList = lista),
            ayuda: "Seleccionar archivo desde la Galería o la Cámara",
            theme: theme,
          ),

          buildMediaCard(
            title: "c) Si el electrodoméstico resultare irreparable adjuntar informe del técnico responsable y 3 presupuestos por cada electrodoméstico igual o similar dañado.",
            ...
            buildMediaCard(
            title: "d) Fotocopia de cedula del titular del suministro.",
            files: selectedFileFotocopiaSimpleCedulaSolicitanteList,
            onChanged: (lista) =>
                setState(() => selectedFileFotocopiaSimpleCedulaSolicitanteList = lista),
            ayuda: "Seleccionar archivo desde la selectedFileFotocopiaSimpleCedulaSolicitanteList o la Cámara",
            theme: theme,
          ),
        ],
      ),
